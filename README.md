...
1. **Register domain** (~CHF 15/yr, e.g. Infomaniak). The pages assume `deklara.ch` — if you register something else, search-and-replace `deklara.ch` in `index.html`, `fr/index.html`, `en/index.html`, `robots.txt`, `sitemap.xml`.
